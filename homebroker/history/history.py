...
########################
    ...
    def get_intraday_history(self, symbol, from_date, to_date):
        """
        Returns the historical quotes of the specified ticker narroweed by the date.
        ...
        #print('from_date->',self.__convert_datetime_to_epoch(from_date))
        #print('to_date->',self.__convert_datetime_to_epoch(to_date))
